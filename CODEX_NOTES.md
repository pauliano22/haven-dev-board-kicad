...
**Remaining SDA gap**: the net still has one more unconnected pair -- an existing `Track [SDA]` on In3.Cu not yet linked to `Pad E4` of U2 (B.Cu), a completely separate connection from the MDBT531-U5 one just closed. Not yet investigated.
