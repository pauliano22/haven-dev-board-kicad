...
root=pathlib.Path('C:/Work/haven-board/routing-evidence/session4')
...
for ref in sys.argv[1:] or pads:
 ...
 for k,l in enumerate(['F_Cu','In1_Cu','In2_Cu','In3_Cu','In4_Cu','B_Cu']):
  svg=pathlib.Path(os.environ.get('HAVEN_SVG_DIR','C:/Work/haven-svg')+'/haven_dev_board-'+l+'.svg').read_text()
