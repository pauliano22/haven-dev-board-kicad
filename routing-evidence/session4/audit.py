...
root=pathlib.Path('C:/Work/haven-board');ev=root/'routing-evidence/session4'
sys.path.insert(0,str(root/'extracted'))
from sexp_parser import parse,get,get_all_immediate as nodes
base=parse(subprocess.check_output(['git','-C',str(root),'show','5fd8faa:kicad/haven_dev_board.kicad_pcb'],text=True))[0]
...
refs=['C6','C8','C9','C13','C22','C34','C38','C44','C46']
for ref in refs:
